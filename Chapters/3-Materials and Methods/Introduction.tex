...
\begin{figure}
    \centering
    \includegraphics{}
    \caption{Schematic diagram of the analytical method applied for the determination the target PFCs in batch test filtrates adapted from \citep{arvaniti2012diagram}.}
