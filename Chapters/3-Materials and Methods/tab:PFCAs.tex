\begin{table}
\centering
\caption{the target compounds used for spiking the batch tests. PFCs correspond to the number of perfluorinated carbon units in the chain. Note: PFCAs appear in dissociated form due to low $K_a$'s at environmentally relevant pH's.}
