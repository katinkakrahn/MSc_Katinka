...
A project partner at NTNU screened the soil for PFAS using a methanol extraction, solid-phase extraction (SPE)-method, and quantification by liquid chromatography-tandem mass spectrometry (LC-MS/MS). 

\begin{table}[bt]
\centering
\caption{PFAS compounds investigated in this study. Note: PFCAs appear in dissociated form at environmentally relevant pH's due to low $pK_a$'s.}
\adjustbox{max width=\textwidth}{
\label{tab:PFCAs}
...
In this study, batch tests were conducted to investigate the distribution of PFAS between biochar and water at various concentrations, and to determine the sorption strength of biochar. 