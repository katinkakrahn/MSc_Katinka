...
\subfloat[\label{subfig:SA_small}]{%
  \includegraphics[width=0.32\textwidth]{R/figs/SA_small.pdf}
}
\hfill
\subfloat[\label{subfig:PV_small}]{%
  \includegraphics[width=0.32\textwidth]{R/figs/PV_small.pdf}
}
\hfill
\subfloat[\label{subfig:SAPV_small}]{%
  \includegraphics[width=0.32\textwidth]{R/figs/SAPV_small.pdf}
}
