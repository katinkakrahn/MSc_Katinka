...
For pores 0.4-1.5 nm, SSA for CWC was $\sim$ six times higher than ULS and DSL (165 and 87  m\textsuperscript{2} g\textsuperscript{-1}, respectively), but the SA/PV ratios are very similar (3 674, 3 502, and 3 206 m\textsuperscript{2} cm\textsuperscript{-3} for CWC, ULS, and DSL respectively). 
...
\begin{table}
\centering
\caption{Surface area (SA), pore volume (PV) and elemental content (C, O, H, N) and ratios for the biochars produced for the batch tests.}
\adjustbox{max width=\textwidth}{
\label{tab:SAPV}
...
CWC & 700 & 323 & 0.017 & 631 & 683 & 0.186 & 3 502 & 91.4 & 5.50 & 1.01 & 0.69 & 0.06 & 0.01 & 0.008       \\
ULS & 700 & 128 & 0.126 & 1 633 & 165 & 0.047 & 3 674 & 29.6 & 57.1 & 1.24 & 1.13 & 1.9  & 0.04 & 0.04        \\
DSL & 700 & 110 & 0.111 & 634 & 87  & 0.027 & 3 206 & 13.5 & 61.4 & 1.05 & 0.82 & 4.6  & 0.08 & 0.06       \\ \bottomrule
\end{tabular}}
\end{table}

% Check what Dmax and Deff means
\begin{table}
...
\caption{Pore size distribution for pores $>$ 1.5 nm. (a) Surface area, (b) pore volume, }
\label{fig:SA_PV_distr}
\end{figure}
...
\caption{(a) Plot of carbon content versus $log~K_d$ (b) Plot of surface area to pore volume ratio versus $log~K_d$. (c) plot of (SA/PV)/C ratio, shows that individually, a and b does not explain sorption, but together they do. Error bars are the propagated standard error, log Kd normalized to 1 ugL.}
\label{fig:Kd_SAPV_C}
\end{figure}
...
\caption{SA/PV ratio for pores $>$1.5 nm normalized to carbon content (g C g BC\textsuperscript{-1}). A lower SA/PV/C ratio indicates a higher degree of C in the pore wall matrix.}
\label{fig:SAPV_C}
\end{figure}
