...
\crefrange{fig:CWC_isotherm}{fig:DSL_isotherm} show sorption isotherms for the single-compound batch tests for CWC, ULS and DSL.
...
\begin{figure}
    \centering
        \begin{subfigure}[t]{\linewidth}
            \centering
            \includegraphics[scale=0.5]{R/figs/ULS_facet_isotherm.pdf}
            \caption{ULS isotherms}
            \label{fig:ULS_isotherm}
        \end{subfigure}
        \begin{subfigure}[]{\linewidth}
            \centering
            \includegraphics[scale=0.5]{R/figs/DSL_facet_isotherm.pdf}
            \caption{DSL isotherms}
            \label{fig:DSL_isotherm}
        \end{subfigure}   
        \begin{subfigure}[]{\linewidth}
            \centering
            \includegraphics[scale=0.5]{R/figs/CWC_facet_isotherm.pdf}
