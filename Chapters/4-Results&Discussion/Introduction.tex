...
\subsection{Effect of biochar structure and composition}
...
\caption{(a) Plot of carbon content versus $log~K_d$ (b) Plot of surface area to pore volume ratio versus $log~K_d$. (c) plot of (SA/PV)/C ratio, shows that individually, a and b does not explain sorption, but together they do.}
\label{fig:Kd_SAPV_C}
\end{figure}

\begin{figure}[!ht]
\subfloat[\label{subfig:Kd_C}]{%
  \includegraphics[width=0.32\textwidth]{R/figs/SAPV_l.pdf}
}
\hfill
\subfloat[\label{subfig:Kd_SAPV}]{%
  \includegraphics[width=0.32\textwidth]{R/figs/Kd_1ugL_SA_PV.pdf}
