...
%\providecommand\phantomsection{} % Denne gjør at det vil kompilere både med og uten hyperref som funker
...
% Ordner nummerering av floats innenfor sine respektive avsnitt.
...
% jeg er fan av å holde figurer på Topp, Bunn eller egen Page, men hvis du vil bruke !h også kan du endre til "placement={!htbp}"
...
\includepdf{Chapters/0-Div/Forside.pdf}

%\pagenumbering{arabic} %sidetall etter innholdsfortegnelse
\pagestyle{plain}
\pagenumbering{roman}
\setcounter{page}{2} %%%%%%%%%% nummeret her styrer hvilket sidetall man begynner på
...
%\afterpage{\blankpage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Egil 2022
\include{Chapters/0-Div/Intentional_blank_page}
\include{Chapters/0-Div/Abstract}
%\newpage\null\newpage %%%%%%%%%%%%%%%%%% Egil 2022
\include{Chapters/0-Div/Intentional_blank_page}
\include{Chapters/0-Div/Sammendrag}
%\newpage\null\newpage %%%%%%%%%%%%%%%%%% Egil 2022
\include{Chapters/0-Div/Intentional_blank_page}
\include{Chapters/0-Div/Preface}
%\newpage\null\newpage %%%%%%%%%%%%%%%%%% Egil 2022
\include{Chapters/0-Div/Intentional_blank_page}
\include{Chapters/0-Div/Acknowledgements}

\input{Lister/Acronyms}
\addcontentsline{toc}{chapter}{Abbreviations}
\clearpage

\clearpage
\input{Lister/Symbols}
...
%\part{Introduction}
%Introduction:
\input{Chapters/1-Introduction/Text}
\newpage


%Literature
\input{Chapters/2-Objectives/Text}
\newpage

%\part{Materials and Methods}
%Experiments in lab
\input{Chapters/3-Materials_and_Methods/Text}
\newpage
...
\input{Chapters/4-Results_and_Discussion/Text}
\newpage

%Conclusions
%\part{Conclusion}{Implications, conclusion, and recommendations for further work}
\input{Chapters/5-Conclusion/Text}
\newpage
...
\input{Appendix/VedleggMAIN}
\includepdf{Chapters/0-Div/m-bakside_a4.pdf}
\end{document}