...
\pagestyle{plain}
\pagenumbering{roman}
\setcounter{page}{3} %%%%%%%%%% nummeret her styrer hvilket sidetall man begynner på
...
%Further work
\input{Chapters/6-Further_work/Text}
%\newpage

%\input{Theory} % midlertidig for å se hvordan det blir. Flyttet til litterature
%\input{Konklusjon}
%input{Referanser}
% Symbolliste
